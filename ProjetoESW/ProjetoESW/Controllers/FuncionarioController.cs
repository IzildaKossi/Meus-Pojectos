...
namespace ESW19Backup2.Controllers
{
    public class FuncionarioController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("FuncionarioId,Nome,Sobrenome,Idade,Data,Telemovel,Email")] Funcionario funcionario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("FuncionarioId,Nome,Sobrenome,Idade,Data,Telemovel,Email")] Funcionario funcionario)
        {
