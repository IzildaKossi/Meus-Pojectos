...
using ESW19Backup2.Models.ManageViewModels;
...
namespace ESW19Backup2.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public async Task<IActionResult> Index(IndexViewModel model)
        {
            ...
            StatusMessage = "O teu perfil foi actualizado";
        ...
        public async Task<IActionResult> SendVerificationEmail(IndexViewModel model)
        {
            ...
            StatusMessage = "Foi enviado um email. Por favor verifique a sua conta";
            return RedirectToAction(nameof(Index));
        }
        ...
        private string GenerateQrCodeUri(string email, string unformattedKey)
        {
            return string.Format(
                ...
                _urlEncoder.Encode("ESW19Backup2"),
